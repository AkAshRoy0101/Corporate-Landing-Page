    ...
    <div className="servicemaincontainer">
      ...
      <div className="webdev">
        ...
        <div className="descandimg">
          <Link to={'/contacts'}><h4 className="servicetitle">Portfolio Website</h4></Link>
          <img
        ...
        <div className="descandimg">
          <Link to={'/contacts'}><h4 className="servicetitle">Personal website</h4></Link>
          <img
        ...
        <div className="descandimg">
          <Link to={'/contacts'}><h4 className="servicetitle">Portfolio</h4></Link>
          <img
            src="https://assets.materialup.com/uploads/28a542c8-abfb-48c5-9301-3efd837518d6/preview.jpg"
            alt=""
            className="serviceimages"
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">Blogs</h4></Link>
          <img
        ...
        <div className="descandimg">
          <Link to={'/contacts'}><h4 className="servicetitle">Bussiness Website</h4></Link>
          <img
        ...
        <div className="descandimg">
          <Link to={'/contacts'}><h4 className="servicetitle">Ecommerce website</h4></Link>
          <img
      ...
      <div className="graphics">
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">Web Design</h4></Link>
            <img
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">UI and UX Design</h4></Link>
            <img
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">Motion Graphics and Animation</h4></Link>
            <img
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">Advertizing and Market Designing</h4></Link>
            <img
      ...
      <div className="mobile">
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">native</h4></Link>
            <img
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">Cross Platform</h4></Link>
            <img
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">hybrid</h4></Link>
            <img
      ...
      <div className="photo">
        <h3>PhotoGrapgy</h3>
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">Landscape</h4></Link>
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">Wedding</h4></Link>            
            <img
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">Fashion</h4></Link>
            <img
        ...
        <div className="descandimg">
            <Link to={'/contacts'}><h4 className="servicetitle">Documentry</h4></Link>
            <img
